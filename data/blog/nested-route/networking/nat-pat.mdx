...
```
![pat-explanation](/static/images/bimages/nat-pat/pat-explanation.jpg "PAT uses unique source port numbers on the inside global (public) IP address to distinguish between translations.")
```
